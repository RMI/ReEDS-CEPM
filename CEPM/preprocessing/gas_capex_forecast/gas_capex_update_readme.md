...
- `gas_CAPEX_update_v1_ccgt_low.csv` — Gas-CC = CCGT low-cost scenario, Gas-CT = CT forecast.
- `gas_CAPEX_update_v2_ccgt_high.csv` — Gas-CC = CCGT high-cost scenario, Gas-CT = CT forecast.
- `gas_CAPEX_update_v3_ccgt_all.csv` — Gas-CC = CCGT all-data (mid/reference) scenario, Gas-CT = CT forecast.
